...
public class SolitaireGame {
    ...
    FoundationDeck[] foundation = new FoundationDeck[Palo.values().length];
    ...
    Pila<Movimientos> historial = new Pila<Movimientos>(512);
    int moveCount = 0;
    ...
    int k = 0;
    while (true) {
        CartaInglesa c = wastePile.getCarta(); // toma la carta visible del waste
        if (c == null) break;
        drawPile.pushCardOnTop(c);             // la regresa arriba del mazo (face-down)
        k++;
    }
    historial.push(new Movimientos(2, -1, -1, k, false, -1, null));
    ...
    public void drawCards() {
        ...
        historial.push(new Movimientos(1, -1, -1, k, false, -1, null));
    ...
    public boolean moveWasteToTableau(int dest) {
        ...
        if (carta != null && d.sePuedeAgregarCarta(carta)) {
            ...
            historial.push(new Movimientos(3, -1, dest-1, 1, false, -1, null));
    ...
    public boolean moveWasteToFoundation() {
        ...
        historial.push(new Movimientos(4, -1, -1, 1, false, fidx, null));
    ...
    public boolean moveTableauToTableau(int origen, int destino) {
        ...
        historial.push(new Movimientos(5, origen - 1, destino - 1, k, flipped, -1, copiaParaUndo));
        moveCount++;
        return true;
    }
    ...
    public boolean moveTableauToFoundation(int numero) {
        ...
        int fidx = carta.getPalo().ordinal();
        historial.push(new Movimientos(6, numero - 1, -1, 1, flipped, fidx, null));
